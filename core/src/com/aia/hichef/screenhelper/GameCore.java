...
public abstract class GameCore implements ApplicationListener {
	...
	public void render() {
		...
		DownloadManager.getInstance().update();
	...
	public void setPlatformResolver(PlatformResolver resolver) {
		this.flatformResolver = resolver;
	}
	...
	public void saveDeviceInfo() {
		AppPreference.instance._deviceName = flatformResolver.getDeviceName();
		AppPreference.instance._deviceID = flatformResolver.getDeviceID();
