...
import com.aia.hichef.enums.Density;
...
public class Toast {
	public static int LENGTH_LONG = 5;
	...
	private void init() {
		if (toast == null) {
			...
			NinePatch patch = new NinePatch(Assets.instance.uiP.textfield, 4,
					4, 4, 4);
			patch.setColor(Color.RED);
			back = new Image(patch);
			back.getColor().a = 0.9f;
			labelStyle.font = Assets.instance.fontFactory.getRegular20();
