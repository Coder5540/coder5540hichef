 ...
 * @author Nathan Sweet
 */
public class CustomScroll extends WidgetGroup {
	 ...
	 *            May be null.
	 */
	public CustomScroll(Actor widget) {
	 ...
	 *            May be null.
	 */
	public CustomScroll(Actor widget, Skin skin) {
	 ...
	 *            May be null.
	 */
	public CustomScroll(Actor widget, Skin skin, String styleName) {
	 ...
	 *            May be null.
	 */
	public CustomScroll(Actor widget, ScrollPaneStyle style) {
		if (style == null)
		...
		addCaptureListener(new InputListener() {
			...
			public boolean touchDown(InputEvent event, float x, float y,
				...
				if (pointer == 0 && button != 0)
					return false;
				getStage().setScrollFocus(CustomScroll.this);
	...
	/**
	 * Set the position of the vertical and horizontal scroll bars (if they
	 * exist).
	 * 
	 * @param bottom
	 *            sets horizontal scroll bar to be at the bottom or the top
	 * @param right
	 *            sets vertical scroll bar to be at the right or the left
	 */
	...
	static public class ScrollPaneStyle {
		...
		public ScrollPaneStyle(Drawable background, Drawable hScroll,
