...
public class Request {
	...
	public void requestQuitApp(int _userID, int sessionId,
			HttpResponseListener listener) {
		get(CommandRequest.USER_QUIT_APP,
				ParamsBuilder.builder().add(ExtParamsKey.ID, _userID)
						.add(StringSystem._SESSION_ID, sessionId).build(),
				listener);
	}
