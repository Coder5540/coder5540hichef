...
import com.aia.hichef.networks.MD5Good;
import com.aia.hichef.screenhelper.GameCore;
import com.aia.hichef.ui.n.DataCache;
...
public class ImgDownloader implements Poolable {
	public boolean						isCacheSDCard	= false;
	public boolean						useOneThread	= false;
	...
	public ImgDownloader(GameCore game) {
		this();
		this.game = game;
	}
	...
	class DownloadTask implements Runnable {
		...
		private Pixmap download(String url) {
			...
			try {
				if (isCacheSDCard) {
					if (!pref.getString(fileName, "").equalsIgnoreCase("")) {
